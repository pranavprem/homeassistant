...
- `automation` — homeassistant, grocy, homebutler, mosquitto, govee2mqtt; the
  optional Zigbee2MQTT add-on stack joins this network through
  `docker-compose.zigbee.yaml`
